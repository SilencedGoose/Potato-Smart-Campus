defmodule SmartCampusWeb.SmartCampusLive do
  ...
  def mount(_params, _session, socket) do
    ...
    IO.inspect(self())
    {:ok, assign(socket, temperature: 0, humidity: 0, noise: 0, light: 0, motion: "Active", co2: 0, datetime: "17 Oct 2023 12:00:00", hardware_status: "Working", sensor_node_status: "Working", sensor_status: "Working", sensor_data_status: "Received")}
  end
